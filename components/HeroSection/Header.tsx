  ...
  return (
    <div className="absolute z-30 top-0 left-0 w-screen bg-[#7e0000] py-3.5 px-5 sm:px-8 xl:px-30">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <button
            className={`${notoSansSC.className} text-[8px] sm:text-[12px]  text-white bg-[#1778e1] px-5 sm:px-7 md:px-10  py-2.5 sm:py-3 rounded-lg tracking-widest uppercase`}
          >
            Entering <span className="font-bold">BP9</span>
          </button>
          <p className="text-[8px] sm:text-[12px]  text-white">X</p>
        </div>
      </div>
    </div>
  );
